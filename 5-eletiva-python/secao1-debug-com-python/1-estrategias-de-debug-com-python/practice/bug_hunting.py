...
# Com o debuger foi verificado que podemos resolver o bug:
# alterando as chaves do DIGITS_MAP para str;
# convertendo os valores da lista digits para int antes das chamadas DIGITS_MAP.get(...)
